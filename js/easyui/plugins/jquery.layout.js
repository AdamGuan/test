...
(function($) {
    ...
    function _1b(_1c, _1d) {
        ...
        if (_1d == "east") {
            ...
            _1e.center.panel("resize", {
                width: _1e.center.panel("options").width + _1e.east.panel("options").width - 28
            });
            _1e.east.panel("panel").animate({
                left: cc.width()
            },
            function() {
                _1e.east.panel("close");
                _1e.expandEast.panel("open").panel("resize", {
                    top: _1e.east.panel("options").top,
                    left: cc.width() - 28,
                    width: 28,
                    height: _1e.east.panel("options").height
                });
            ...
            if (!_1e.expandEast) {
                ...
                _1e.expandEast.panel("panel").click(function() {
                    _1e.east.panel("open").panel("resize", {
                        left: cc.width()
                    });
                    _1e.east.panel("panel").animate({
                        left: cc.width() - _1e.east.panel("options").width
                    });
                    return false;
                });
            }
            ...
            if (_1d == "west") {
                ...
                _1e.center.panel("resize", {
                    width: _1e.center.panel("options").width + _1e.west.panel("options").width - 28,
                    left: 28
                });
                _1e.west.panel("panel").animate({
                    left: -_1e.west.panel("options").width
                },
                function() {
                    _1e.west.panel("close");
                    _1e.expandWest.panel("open").panel("resize", {
                        top: _1e.west.panel("options").top,
                        left: 0,
                        width: 28,
                        height: _1e.west.panel("options").height
                    });
                ...
                if (!_1e.expandWest) {
                    ...
                    _1e.expandWest.panel("panel").click(function() {
                        _1e.west.panel("open").panel("resize", {
                            left: -_1e.west.panel("options").width
                        });
                        _1e.west.panel("panel").animate({
                            left: 0
                ...
                if (_1d == "north") {
                    ...
                    _1e.east.panel("resize", {
                        top: 28,
                        height: hh
                    });
                    _1e.west.panel("resize", {
                        top: 28,
                        height: hh
                    });
                    if (_b(_1e.expandEast)) {
                        _1e.expandEast.panel("resize", {
                            top: 28,
                            height: hh
                        });
                    }
                    if (_b(_1e.expandWest)) {
                        _1e.expandWest.panel("resize", {
                            top: 28,
                            height: hh
                        });
                    }
                    _1e.north.panel("panel").animate({
                        top: -_1e.north.panel("options").height
                    },
                    function() {
                        _1e.north.panel("close");
                        _1e.expandNorth.panel("open").panel("resize", {
                            top: 0,
                            left: 0,
                            width: cc.width(),
                            height: 28
                    ...
                    if (!_1e.expandNorth) {
                        ...
                        _1e.expandNorth.panel("panel").click(function() {
                            _1e.north.panel("open").panel("resize", {
                                top: -_1e.north.panel("options").height
                            });
                            _1e.north.panel("panel").animate({
                                top: 0
                    ...
                    if (_1d == "south") {
                        ...
                        _1e.south.panel("panel").animate({
                            top: cc.height()
                        },
                        function() {
                            _1e.south.panel("close");
                            _1e.expandSouth.panel("open").panel("resize", {
                                top: cc.height() - 28,
                                left: 0,
                                width: cc.width(),
                                height: 28
                        ...
                        if (!_1e.expandSouth) {
                            ...
                            _1e.expandSouth.panel("panel").click(function() {
                                _1e.south.panel("open").panel("resize", {
                                    top: cc.height()
                                });
                                _1e.south.panel("panel").animate({
                                    top: cc.height() - _1e.south.panel("options").height
                                });
                                return false;
                            });
                        }
    ...
    function _21(_22, _23) {
        ...
        if (_23 == "east" && _24.expandEast) {
            ...
            _24.east.panel("open").panel("resize", {
                left: cc.width()
            });
            _24.east.panel("panel").animate({
                left: cc.width() - _24.east.panel("options").width
            },
            function() {
                _2(_22);
            ...
            if (_23 == "west" && _24.expandWest) {
                ...
                _24.west.panel("open").panel("resize", {
                    left: -_24.west.panel("options").width
                });
                _24.west.panel("panel").animate({
                    left: 0
                },
                function() {
                    _2(_22);
                ...
                if (_23 == "north" && _24.expandNorth) {
                    ...
                    _24.north.panel("open").panel("resize", {
                        top: -_24.north.panel("options").height
                    });
                    _24.north.panel("panel").animate({
                        top: 0
                    },
                    function() {
                        _2(_22);
                    ...
                    if (_23 == "south" && _24.expandSouth) {
                        ...
                        _24.south.panel("open").panel("resize", {
                            top: cc.height()
                        });
                        _24.south.panel("panel").animate({
                            top: cc.height() - _24.south.panel("options").height
                        },
                        function() {
                            _2(_22);
    ...
    function _25(_26) {
        ...
        function _1b(e) {
            ...
            if (e.data != "west" && _b(_27.west) && _b(_27.expandWest)) {
                _27.west.panel("panel").animate({
                    left: -_27.west.panel("options").width
                },
                function() {
            ...
            if (e.data != "north" && _b(_27.north) && _b(_27.expandNorth)) {
                _27.north.panel("panel").animate({
                    top: -_27.north.panel("options").height
                },
                function() {
